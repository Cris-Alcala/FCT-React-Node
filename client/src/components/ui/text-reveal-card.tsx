    ...
    >
      ...
      <div className="h-20 relative flex items-center overflow-hidden">
        <motion.div
          ...
          className="absolute bg-gray-100 z-20 will-change-transform"
        >
          <div className="overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
            <p
              ...
              className="md:text-[2rem] text-[1rem] py-10 font-bold bg-clip-text text-transparent bg-[#323238] px-5 w-full"
            >
              {revealText}
            </p>
          </div>
